...
const AuthLayout = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-agri-50/30 to-emerald-50/40 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        <Link to="/" className="inline-flex items-center space-x-3 group">
          ...
          <span className="font-extrabold text-2xl text-slate-900 tracking-tight">AGRI SMART AI</span>
        </Link>
